...
public class AahProcessServiceWithoutCallable implements Callable<Map<String, Set<ActualSupplierData>>> {
    Map<String,Set<ActualSupplierData>> cascadeDataForAah;
    public AahProcessServiceWithoutCallable(Map<String,Set<ActualSupplierData>> cascadeDataForAah){
    ...
    public static void main(String args[]) throws InterruptedException, JsonProcessingException {
        ...
        AahProcessServiceWithoutCallable process = new AahProcessServiceWithoutCallable(cascadeResultsMap);
        ...
        Map<String,Set<ActualSupplierData>> processedSigmaData = process.call();
